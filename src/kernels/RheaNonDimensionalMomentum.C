...
RheaNonDimensionalMomentum::RheaNonDimensionalMomentum(const InputParameters & parameters) :
  Kernel(parameters),
    // Coupled values:
...
Real RheaNonDimensionalMomentum::computeQpResidual()
{
...
Real RheaNonDimensionalMomentum::computeQpJacobian()
{
//  // Compute velocity and pressure
//  Real vel = _u[_qp]/_rho[_qp];
...
Real RheaNonDimensionalMomentum::computeQpOffDiagJacobian( unsigned int _jvar)
{
